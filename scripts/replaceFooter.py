...
def replace_second_last_section(file_name):
    ...
    <a href="https://github.com/gurudev108/jyotishi.ai" style="flex: 1 1;height: 4rem;position: absolute;width: 100%;z-index: 1;">
    ...
    <a style="z-index:1" href="https://github.com/gurudev108/jyotishi.ai">GitHub Open Source @jyotishi.ai</a></section>
